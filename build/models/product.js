...
var ProductStore = /** @class */ (function () {
    ...
    ProductStore.prototype.show = function (productId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, database_1.default.query(sql, [productId])];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result.rows.length ? result.rows[0] : null];
                    case 2:
                        err_2 = _a.sent();
                        throw new Error("Unable to get product with ID ".concat(productId, ": ").concat(err_2));
                    case 3: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        err_3 = _a.sent();
                        throw new Error("Unable to add product: ".concat(err_3));
                    case 3: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        err_4 = _a.sent();
                        throw new Error("Unable to delete product with ID ".concat(productId, ": ").concat(err_4));
                    case 3: return [2 /*return*/];
                }
            });
        });
